...
class HolehePlugin:
    ...
    async def run(self, entity: str) -> list[Finding]:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            # Deliberately not passing --timeout: holehe 1.61's argparse
            # stores an explicit value as a string instead of an int,
            # which makes every module raise immediately.
            args = [entity, "--csv"]
